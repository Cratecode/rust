...
_(`u32` is an unsigned 32-bit integer, see
...
Keep in mind that, if you don't specify a return type, the function will still
...
Now that you understand some of Rust's basic syntax, there's just one more
